                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: MenuItemWidget(
                                ...
                                isActive: FFAppState().activePage ==
                                    'Support Messages',
                                activeIcon: Icon(
                                  Icons.chat_rounded,
                                  color:
                                ...
                                navigateAction: () async {
                                  context.pushNamed(
                                    SupportMessagePageWidget.routeName,
                                    extra: <String, dynamic>{
                                      kTransitionInfoKey: TransitionInfo(
                                        hasTransition: true,
                                        transitionType: PageTransitionType.fade,
                            ...
                            wrapWithModel(
                              ...
                              child: MenuItemWidget(
                                ...
                                navigateAction: () async {
                                  context.pushNamed(
                                    PropertiesPageWidget.routeName,
                                    extra: <String, dynamic>{
                                      kTransitionInfoKey: TransitionInfo(
                                        hasTransition: true,
                                        transitionType: PageTransitionType.fade,
                            ...
                            wrapWithModel(
                              ...
                              child: MenuItemWidget(
                                ...
                                navigateAction: () async {
                                  context.pushNamed(
                                    AgentRequestsPageWidget.routeName,
                                    extra: <String, dynamic>{
                                      kTransitionInfoKey: TransitionInfo(
                                        hasTransition: true,
                                        transitionType: PageTransitionType.fade,
