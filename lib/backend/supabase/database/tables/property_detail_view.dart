...
class PropertyDetailViewTable extends SupabaseTable<PropertyDetailViewRow> {
  @override
  String get tableName => 'property_detail_view';

  @override
  PropertyDetailViewRow createRow(Map<String, dynamic> data) =>
      PropertyDetailViewRow(data);
}

class PropertyDetailViewRow extends SupabaseDataRow {
  PropertyDetailViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PropertyDetailViewTable();
  ...
  String? get assignedUser => getField<String>('assigned_user');
  set assignedUser(String? value) => setField<String>('assigned_user', value);
  ...
  dynamic? get priceHistory => getField<dynamic>('price_history');
  set priceHistory(dynamic? value) => setField<dynamic>('price_history', value);
  ...
  double? get priceForMeter => getField<double>('price_for_meter');
  set priceForMeter(double? value) =>
      setField<double>('price_for_meter', value);
  ...
  String? get assignedUserFirstName =>
      getField<String>('assigned_user_first_name');
  set assignedUserFirstName(String? value) =>
      setField<String>('assigned_user_first_name', value);

  String? get assignedUserLastName =>
      getField<String>('assigned_user_last_name');
  set assignedUserLastName(String? value) =>
      setField<String>('assigned_user_last_name', value);

  String? get assignedUserPhone => getField<String>('assigned_user_phone');
  set assignedUserPhone(String? value) =>
      setField<String>('assigned_user_phone', value);

  String? get assignedUserEmail => getField<String>('assigned_user_email');
  set assignedUserEmail(String? value) =>
      setField<String>('assigned_user_email', value);

  String? get assignedUserPhotoUrl =>
      getField<String>('assigned_user_photo_url');
  set assignedUserPhotoUrl(String? value) =>
      setField<String>('assigned_user_photo_url', value);

  String? get assignedUserDescription =>
      getField<String>('assigned_user_description');
  set assignedUserDescription(String? value) =>
      setField<String>('assigned_user_description', value);

  bool? get userDeleted => getField<bool>('user_deleted');
  set userDeleted(bool? value) => setField<bool>('user_deleted', value);
}
